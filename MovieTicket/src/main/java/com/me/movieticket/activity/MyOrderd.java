...
public class MyOrderd extends AppCompatActivity{
    //private ListView lv_list;
    private PullToRefreshListView lv_list;
    private OrderdAdapter orderAdapter;
    //private static List<Order> order_list_data;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_myorderd);
        lv_list = (PullToRefreshListView) findViewById(R.id.neworderd_list);
        //设置下拉刷新
        initData();
...
//            }
    ...
    private void initData() {
        ...
        query.addWhereEqualTo("isused", false);
        //返回50条数据，如果不加上这条语句，默认返回10条数据
        //query.setLimit(50);
        //执行查询方法
        Log.i("zhixinginitdata","1213213212132");
                ...
                .findObjects(new FindListener<Order>() {
                    ...
                    public void done(List<Order> order_list_data, BmobException e) {
                        if(e==null){
                            ...
                            orderAdapter = new OrderdAdapter(MyOrderd.this,order_list_data);
                            lv_list.setAdapter(orderAdapter);
                            Toast.makeText(MyOrderd.this,"查询成功：共" + order_list_data.size() + "条数据。",Toast.LENGTH_SHORT);
                            Log.i("zhixinginitdata","数据长度"+order_list_data.size());

                        }else{
                            Toast.makeText(MyOrderd.this,"查询订单失败",Toast.LENGTH_SHORT);
                        }
                    }
                });
    }
    ...
    private static class LoadDataAsyncTask extends AsyncTask<Void,Void,String> {
        ...
        private MyOrderd mainActivity;

        public LoadDataAsyncTask(MyOrderd mainActivity) {
