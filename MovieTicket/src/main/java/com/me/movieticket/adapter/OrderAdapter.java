...
public class OrderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.tv_movie_name = (TextView) convertView.findViewById(R.id.order_movie_name);
            viewHolder.tv_movie_time = (TextView) convertView.findViewById(R.id.order_movie_time);
            viewHolder.tv_movie_location = (TextView) convertView.findViewById(R.id.order_movie_location);
            viewHolder.tv_movie_seat = (TextView) convertView.findViewById(R.id.order_movie_seat);
            viewHolder.tv_movie_price = (TextView) convertView.findViewById(R.id.order_movie_price);
